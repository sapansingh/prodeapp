...
const navigation = [
  { name: 'Dashboard', href: '#',to:'/' ,current: false },
  { name: 'Analytics', href: '#',to:'/Analytics/Assignment', current: false },
  { name: 'Penalty Deshbord', href: '#',to:'/penalty', current: false },
  { name: 'Assets Master', href: '#',to:'/Assetsmaster', current: false },
  { name: 'It Admin', href: '#',to:'/admin', current: false },
  { name: 'Merit Triggers', href: '#',to:'/meritalerts', current: false },
  { name: 'Call Recordings', href: '#',to:'/callrecording', current: false },
  { name: 'Reports', href: '#',to:'/re', current: false },
]
// const menu=[
