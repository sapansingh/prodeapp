...
<table className="w-full text-sm text-left rtl:text-rightdark:text-blue-100">
<thead className="text-xs text-black uppercaseborder-b border-blue-400 dark:text-black">
<tr>
...
<tdclassName="px-6 py-4 font-mediumwhitespace-nowrap dark:text-blue-100">
 {assets.device}
</td>
<td className="px-6 py-4">
{assets.make}
...
<td className="px-6 py-4">
<Link href="#" className="font-mediumhover:underline">Edit</Link>
</td>
</tr>
