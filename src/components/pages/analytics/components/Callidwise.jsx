...
const getAssignmentdata=async()=>{
  setistrue(false);
  try{
    const responsedata=await axios.post(apiurl39+"/gvkprod/v2/app/analytics/callidwise.php",satr);
...
const downloadurl=`${apiurl39}/gvkprod/v2/app/analytics/callidwiseexport.php?start=${startDate}&end=${endDate}`;
return (
<>
