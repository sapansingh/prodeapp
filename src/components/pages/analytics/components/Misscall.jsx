...
formData.append('date2', endDate);
  try{
    const responsedata=await axios.post(apiurl+"/gvkprod/v2/app/analytics/misscall.php",satr);
...
let i=0;
const downloadurl=`${apiurl}/gvkprod/v2/app/analytics/misscallexport.php?start=${startDate}&end=${endDate}`;
return (
<>
