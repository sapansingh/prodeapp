...
formData.append('date2', endDate);
  try{
    const responsedata=await axios.post(apiurl+"/gvkprod/v2/app/analytics/vbreport.php",satr);
...
const downloadurl=`${apiurl}/gvkprod/v2/app/analytics/vbreportexport.php?start=${startDate}&end=${endDate}`;
return (
<>
...
<th scope="col" className="px-6 py-3">sent_time</th>
<th scope="col" className="px-6 py-3">followup_time</th>
<th scope="col" className="px-6 py-3">ero_id</th>
<th scope="col" className="px-6 py-3">vb_desk_id</th>
<th scope="col" className="px-6 py-3">submit_time</th>
</tr>
</thead>
<tbody>
