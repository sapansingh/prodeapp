...
formData.append('date2', endDate);
  try{
    const responsedata=await axios.post(apiurl+"/gvkprod/v2/app/analytics/vna.php",satr);
...
const downloadurl=`${apiurl}/gvkprod/v2/app/analytics/vnaexport.php?start=${startDate}&end=${endDate}`;
return (
<>
...
<th scope="col" className="px-6 py-3">
            ...
            <th scope="col" className="px-6 py-3">call_time</th>
            <th scope="col" className="px-6 py-3">phone_number</th>
            <th scope="col" className="px-6 py-3">agent_connected_time</th>
            <th scope="col" className="px-6 py-3">popup_close_time</th>
            <th scope="col" className="px-6 py-3">call_end_time</th>
            <th scope="col" className="px-6 py-3">caller_name</th>
            ...
            <th scope="col" className="px-6 py-3">call_remarks</th>
            <th scope="col" className="px-6 py-3">agent_id</th>
            <th scope="col" className="px-6 py-3">closed_time</th>
            <th scope="col" className="px-6 py-3">chief_complaint_name</th>
            <th scope="col" className="px-6 py-3">standard_remarks_name</th>
