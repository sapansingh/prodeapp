...
const Vtr_with_last_case_wise=()=>{
    useEffect(() => {
        document.title = 'Vtr_with_last_case_wise';
      }, []);
...
formData.append('date2', endDate);
  try{
    const responsedata=await axios.post(apiurl+"/gvkprod/v2/app/analytics/vtrwithlastcase.php",satr);
...
const downloadurl=`${apiurl}/gvkprod/v2/app/analytics/vtrwithlastcaseexport.php?start=${startDate}&end=${endDate}`;
return (
<>
...
export default Vtr_with_last_case_wise;